...
export const SPRITES = {
  ...
  pub: loadSprite("assets/sprites/pub.png"),
  ...
  flowers: loadSprite("assets/sprites/flowers.png"),
  tsunagi: loadSprite("assets/sprites/tsunagi.png"),
  ...
  amina: loadSprite("assets/sprites/amina.png"),
  friends: loadSprite("assets/sprites/friends.png"),
  emo: loadSprite("assets/sprites/emo.png"),
  emo2: loadSprite("assets/sprites/emo2.png"),
  ind: loadSprite("assets/sprites/ind.png"),
  cas: loadSprite("assets/sprites/cas.png"),
  wendy: loadSprite("assets/sprites/wendy.png"),
  zenshin: loadSprite("assets/sprites/zenshin.png"),
  lee: loadSprite("assets/sprites/lee.png"),
  pizza2: loadSprite("assets/sprites/pizza2.png"),
  gyoza: loadSprite("assets/sprites/gyoza.png"),
  tsunagi2: loadSprite("assets/sprites/tsunagi2.png"),
  ...
  hang: loadSprite("assets/sprites/hang.png"),
  gori: loadSprite("assets/sprites/gori.png"),
  ...
  senpu: loadSprite("assets/sprites/senpu.png"),
  ...
  gj1: loadSprite("assets/sprites/gj1.png"),
